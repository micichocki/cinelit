...
import {
  CollectionResponse,
  RepositoryService,
} from "src/app/shared/services/repository.service";
...
export class CollectionComponent {
  ...
  ngOnInit() {
    ...
    this.repositoryService
      .getCollectionByUserId(this.auth.userId)
      .subscribe((res) => (this.repositoryObjects = res));
  }
  ...
  private changeModeCallback(mode: ApplicationMode) {
    ...
    this.title =
      this.mode === "Books" ? "Your books collection" : "Your film collection";
  }
